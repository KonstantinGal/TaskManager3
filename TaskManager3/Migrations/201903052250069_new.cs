namespace TaskManager3.Migrations
{
    ...
    public partial class _new : DbMigration
    {
        public override void Up()
        {
            ...
            AddColumn("dbo.CustomerTasks", "Identity_Id", c => c.String(nullable: false, maxLength: 128));
            ...
            AlterColumn("dbo.CustomerTasks", "Name", c => c.String(nullable: false));
            AlterColumn("dbo.AspNetUserClaims", "UserId", c => c.String());
            CreateIndex("dbo.CustomerTasks", "Identity_Id");
            ...
            AddForeignKey("dbo.CustomerTasks", "Identity_Id", "dbo.IdentityUsers", "Id", cascadeDelete: true);
        ...
        public override void Down()
        {
            ...
            DropColumn("dbo.CustomerTasks", "Identity_Id");
